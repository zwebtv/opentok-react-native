...
public class OTCustomCapture extends BaseVideoCapturer implements
    ...
    private static final String LOG_TAG = OTCustomCapture.class.getSimpleName();
    ...
    public OTCustomCapture(Context context, Publisher.CameraCaptureResolution resolution,
                               Publisher.CameraCaptureFrameRate fps, String orientation) {
     ...
     */
    public interface OTCustomCaptureDataSource {
        public byte[] retrieveMetadata();
    }
    private OTCustomCaptureDataSource metadataSource;
    public void setOTCustomCaptureDataSource(OTCustomCaptureDataSource metadataSource) {
            ...
            if (data.length == expectedFrameSize) {
                ...
                if (metadataSource != null) {
                    ...
                    provideByteArrayFrame(data, NV21, captureWidth,
                            captureHeight, videoOrientation(), isFrontCamera(), framemetadata);
                }
                else {
                    provideByteArrayFrame(data, NV21, captureWidth,
                            captureHeight, videoOrientation(), isFrontCamera());
                }
